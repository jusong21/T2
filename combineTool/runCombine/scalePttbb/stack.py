...
def stackHist(hist, title, xtitle, outname):
	f_ttbb = TFile('/home/juhee5819/cheer/HiggsAnalysis/combineTool/data/scalePttbb/scaled_ttbb.root')
	f_ttbj = TFile('/home/juhee5819/cheer/HiggsAnalysis/combineTool/data/scalePttbb/scaled_ttbj.root')
	f_ttcc = TFile('/home/juhee5819/cheer/HiggsAnalysis/combineTool/data/scalePttbb/scaled_ttcc.root')
	f_Bkg = TFile('/home/juhee5819/cheer/HiggsAnalysis/combineTool/data/scalePttbb/scaled_Bkg.root')
	f_data = TFile('/home/juhee5819/cheer/HiggsAnalysis/combineTool/scale/scaled/merge_ran.root')

	
	h_ttbb_1 = f_ttbb.Get(hist+'_Gen_1')
#	h_ttbb_1.SetFillColor(42)
	#h_ttbb_1.SetFillColor(205)
	#h_ttbb_1.SetFillColor(kViolet-1)
#	h_ttbb_1.SetLineColor(42)
	h_ttbb_2 = f_ttbb.Get(hist+'_Gen_2')
#	h_ttbb_2.SetFillColor(42)
#	h_ttbb_2.SetFillColor(45)
#	h_ttbb_2.SetFillColor(206)
#	h_ttbb_2.SetFillColor(kViolet-2)
#	h_ttbb_2.SetLineColor(kBlack)
#	h_ttbb_2.SetLineColor(42)
	h_ttbb_3 = f_ttbb.Get(hist+'_Gen_3')
#	h_ttbb_3.SetFillColor(42)
#	h_ttbb_3.SetFillColor(46)
#	#h_ttbb_3.SetFillColor(207)
#	#h_ttbb_3.SetFillColor(kViolet-3)
#	h_ttbb_3.SetLineColor(kBlack)
#	h_ttbb_3.SetLineColor(42)
	h_ttbb_4 = f_ttbb.Get(hist+'_Gen_4')
	h_ttbb_1.Add(h_ttbb_2, h_ttbb_3)
	h_ttbb_1.Add(h_ttbb_4, 1)
